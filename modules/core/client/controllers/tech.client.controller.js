(function () {
  ...
  function TechController($scope, $interval) {
    var imgs = ['javascript--transparent', 'HTML5--transparent', 'CSS3--transparent', 'csharp--transparent', 'angular-js', 'jquery--transparent', 'd3js--transparent', 'grunt--transparent', 'mongodb--transparent', 'nodejs--transparent', 'sass-logo'];
